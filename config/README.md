...
- These are the minimum required vars need to setup to make leviatbox Music Bot functional.
...
- You can play tracks or playlists from spotify from leviatbox Music bot
...
- If you plan to use leviatbox Music Bot with your own customized or modified code.
...
- You can change images which are used in leviatbox Music Bot.

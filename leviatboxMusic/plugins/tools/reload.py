...
from leviatboxMusic.utils.database import get_authuser_names, get_cmode
from leviatboxMusic.utils.decorators import language, AdminActual, ActualAdminCB
from leviatboxMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await leviatbox.stop_stream(message.chat.id)
    except:
        pass

...
from leviatboxMusic import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from leviatboxMusic.core.call import leviatbox
from leviatboxMusic.utils import seconds_to_min, time_to_seconds
from leviatboxMusic.utils.channelplay import get_channeplayCB
from leviatboxMusic.utils.database import is_video_allowed
from leviatboxMusic.utils.decorators.language import languageCB
from leviatboxMusic.utils.decorators.play import PlayWrapper
from leviatboxMusic.utils.formatters import formats
from leviatboxMusic.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from leviatboxMusic.utils.inline.playlist import botplaylist_markup
from leviatboxMusic.utils.logger import play_logs
from leviatboxMusic.utils.stream.stream import stream
...
async def play_commnd(
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            try:
                await leviatbox.stream_call(url)
...
@app.on_callback_query(
    filters.regex("leviatboxPlaylists") & ~BANNED_USERS
)
@languageCB
